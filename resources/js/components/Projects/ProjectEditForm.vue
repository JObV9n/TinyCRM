<!-- filepath: c:\Users\Lenovo\Desktop\miso\projects\php_projects\minicrm\resources\js\components\Projects\ProjectEditForm.vue -->
<template>
    <div>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submitForm">
                    ...
                    <!-- Submit button -->
                    <button class="block w-full bg-blue-500 text-white font-bold p-4 rounded-lg">Update</button>
                </form>
            </div>
        </div>
    </div>
...
export default {
    ...
    data() {
        return {
            form: {
                ...
                deadline_at: this.project.deadline_at,
    ...
    methods: {
        submitForm() {
            axios
                .put(`/api/projects/${this.project.id}`, this.form)
                .then(() => {
                    window.location.href = '/projects?message=Project updated successfully';
                })
                .catch((error) => {
