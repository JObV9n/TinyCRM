    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-6">Edit Task</h2>
...
const fetchData = async () => {
    try {
        const [taskRes, usersRes, clientsRes, projectsRes] = await Promise.all([
            tasksAPI.getOne(route.params.id),
